...
// images rotate while scrolling
// window.onscroll = function() {
//   var theta = document.documentElement.scrollTop / 50 % Math.PI;

// document.getElementById('rotatewhilescrolling').style.transform ='rotate(' + theta + 'rad)';
// document.getElementById('rotatewhilescrolling1').style.transform ='rotate(' + theta + 'rad)';
// document.getElementById('rotatewhilescrolling2').style.transform ='rotate(' + theta + 'rad)';
// document.getElementById('rotatewhilescrolling3').style.transform ='rotate(' + theta + 'rad)';
// }

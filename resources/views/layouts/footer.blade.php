            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                <div class="cs-text_widget">
                  <!-- <img src="assets/imgs/logo.png" width="120px" alt="Thumb"> -->
                  <a class="cs-site_branding" style="border: 1px solid #2da8a8; color:#2da8a8; font-weight: bold; font-size: 12px; padding: 6px; margin-bottom:10px; " href="index.html">
              Opti-Web-Serve
              </a>
                  <p>We're a team of professionals doing OUTREACH to find the Blogs and Bloggers to get the Do-follow links from there blogs & Helping the SEO agencies to rank their Clients websites on High CPC Keywords with White Hat link-building services.</p>
                </div>
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                ...
                <ul class="cs-menu_widget cs-mp0">
                  ...
                  <li><a href="service-details.html">Link Building</a></li>
                  <li><a href="service-details.html">Blogging</a></li>
                </ul>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                <h2 class="cs-widget_title">Pakistan Office Address</h2>
                <ul class="cs-menu_widget cs-mp0">
                  <li>Office # 12, 1st floor Kohenoor plaza, Faisalabad, Pakistan</li>
                  <li>+92 303 0638240</li>
                  <li>sheharyarseo@gmail.com</li>
                </ul>
              </div>
            </div>
            <div class="col-lg-3 col-sm-6">
              <div class="cs-footer_item">
                <h2 class="cs-widget_title">United Kingdom Office Address</h2>
                <ul class="cs-menu_widget cs-mp0">
                  <li>223 Green Lanes, Palmers Green London, N11 4BS. United Kingdom</li>
                  <li>sheharyarseo@gmail.com</li>
                </ul>
              </div>
            </div>
      ...
      <div class="container">
        <div class="cs-bottom_footer">
          <div class="cs-bottom_footer_left">
            <!-- <div class="cs-copyright">© Alle Rechte vorbehalten 2023. GURU - Führendes IT-Unternehmen</div> -->
            <div class="cs-copyright">All Rights Reserved 2023</div>
          </div>
